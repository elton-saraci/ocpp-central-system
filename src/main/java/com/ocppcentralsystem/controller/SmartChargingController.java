...
public class SmartChargingController {
    ...
    public ResponseEntity<ChargingProfileResultDTO> setPowerLimit(
        ...
        return ResponseEntity.ok(smartChargingService.setPowerLimit(tenant, cpId, connectorId, powerW, durationMinutes));
    }
    ...
    public ResponseEntity<ChargingProfileResultDTO> clearPowerLimit(
        ...
        return ResponseEntity.ok(smartChargingService.clearPowerLimit(tenant, cpId, connectorId));
    }
    ...
    public ResponseEntity<ChargingScheduleDTO> getPowerLimit(
        ...
        return ResponseEntity.ok(smartChargingService.getPowerLimit(tenant, cpId, connectorId, durationMinutes));
    }
}
